...
public class UrlValidator implements Serializable {
	 ...
	 * 
	 * @param schemes
	 *            Pass in one or more url schemes to consider valid, passing in a
	 *            null will default to "http,https,ftp" being valid. If a non-null
	 *            schemes is specified then all valid schemes must be specified.
	 *            Setting the ALLOW_ALL_SCHEMES option will ignore the contents of
	 *            schemes.
	 */
	 ...
	 *            this class. To set multiple options you simply add them together.
	 *            For example, ALLOW_2_SLASHES + NO_FRAGMENTS enables both of those
	 *            options.
	 */
	 ...
	 * 
	 * @param schemes
	 *            The set of valid schemes. Ignored if the ALLOW_ALL_SCHEMES option
	 *            is set.
	 * @param options
	 *            The options should be set using the public constants declared in
	 *            this class. To set multiple options you simply add them together.
	 ...
	 * @param options
	 *            Validation options. Set using the public constants of this class.
